...
celery-exporter: celery_prometheus_exporter.py Dockerfile-celery4 requirements/*
	docker build -f Dockerfile-celery4 -t ssikyou/celery-exporter:latest .
...
publish: all
	docker push ssikyou/celery-exporter:latest
